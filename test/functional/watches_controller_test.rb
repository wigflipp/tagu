...
class WatchesControllerTest < ActionController::TestCase
  ...
  test "should create watch" do
    assert_difference('Watch.count') do
      post :create, watch: { lesson_number: @watch.lesson_number, member_id: @watch.member_id, watch: @watch.watch }
    end
  ...
  test "should update watch" do
    put :update, id: @watch, watch: { lesson_number: @watch.lesson_number, member_id: @watch.member_id, watch: @watch.watch }
    assert_redirected_to watch_path(assigns(:watch))
  end
